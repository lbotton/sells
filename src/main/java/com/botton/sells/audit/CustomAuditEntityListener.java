package com.botton.sells.audit;
...
public class CustomAuditEntityListener {
  ...
  @PreUpdate
  public void preUpdate(BaseEntity<Long> baseEntity) throws UnknownHostException {
  ...
  @PrePersist
  public void prePersist(BaseEntity<Long> baseEntity) throws UnknownHostException {
    baseEntity.setDateUpdate(LocalDateTime.now());
    if (Objects.isNull(baseEntity.getUserUpdate())) {
      baseEntity.setUserUpdate(USER_SYSTEM_ID);
    }
